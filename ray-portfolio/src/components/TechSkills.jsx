export default function TechSkills() {
  ...
  return (
    <div>
      ...
      <p><strong>Testing/Deployment</strong> | Jest, Mocha, Chai, AWS: EC2/RDS/S3, Heroku</p>
      <p><strong>Developer Tools</strong> | Git, Vim, npm, Nx, Webpack, Babel, Agile Methodology, TDD</p>
    </div>
  )
}